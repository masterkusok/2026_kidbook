...
адрес. [**IP-адрес**](../ip_mac/ip_and_mac.md) — это как координаты дома на
карте. 
...
7.  **Компьютер → Браузер**: «Вот IP, можешь устанавливать соединение по [**HTTP**](../http_https/http_https.md).»
