...
Представь, что интернет — это огромный город. [**IP-адрес**](../ip_mac/ip_and_mac.md) — это координаты дома на карте, а **домен** — это красивая табличка на дверях с твоим именем.
