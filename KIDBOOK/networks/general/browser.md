...
<!-- Картинка: схема компонентов браузера — блоки: Интерфейс, Движок браузера, Движок рендеринга, Сетевой модуль, JavaScript-движок, Хранилище -->
...
<!-- Картинка: пайплайн рендеринга — стрелки: HTML → DOM → Render Tree → Layout → Paint → Composite -->
