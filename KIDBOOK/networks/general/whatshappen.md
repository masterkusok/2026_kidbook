...
<!-- Картинка: схема всего пути от браузера до сервера и обратно — стрелки: Браузер → DNS → Сервер → Браузер, с подписями каждого шага -->
![Схема полного пути от браузера до сервера](../images/what_happens_overview.svg)
...
<!-- Картинка: разобранный URL с подписями каждой части — https:// | ru.wikipedia.org | /wiki/Кот -->
